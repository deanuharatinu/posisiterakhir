  ...
  return (
    <div className="md:border-l-2 md:border-zinc-700/70 md:pl-6">
      <article className="md:grid md:grid-cols-4 md:items-baseline">
        <div className="md:col-span-3 group relative flex flex-col">
          <h2 className="text-base font-semibold tracking-tight text-zinc-100">
            ...
            <a href="/articles/make-managing-dotfiles-a-breeze-with-stow">
              ...
              <span className="relative z-10">Make managing dotfiles a breeze with Stow</span>
            </a>
          </h2>
        ...
        <time className="mt-1 hidden md:block relative z-10 order-first mb-3 items-center text-sm text-zinc-400 dark:text-zinc-500" dateTime="2024-06-18">June 18, 2024</time>
      </article>
    </div>
  )
}