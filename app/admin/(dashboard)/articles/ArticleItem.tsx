...
export default function ArticleItem({ article, index }: { article: any, index: number }) {
  ...
  return (
    <tr className="text-neutral-400">
      ...
      <td className="px-3 py-4 whitespace-nowrap">{formatTimestampToDate(article.created_at)}</td>
      ...
      <td className="py-4 flex flex-row gap-x-6 items-center justify-center">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 hover:stroke-blue-600 transition-colors">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 hover:stroke-red-600 transition-colors">
