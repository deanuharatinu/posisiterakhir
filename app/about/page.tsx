    ...
    <div className="grid lg:grid-cols-2 lg:grid-rows-[auto_1fr] gap-x-4 gap-y-2 items-start mx-2">
      ...
      <section className="mt-12 lg:mt-0 lg:order-first lg:row-span-2">
        ...
        <div className="mt-10 text-base/relaxed text-zinc-400">
          <p>
            I know computers since I was child.
            Such a privilege, to be hands-on the computer (in Indonesia) on such a young age.
            I even already built my family PC from scratch, on elementary school.
            My older brother, who has many experience on competitive programming, handed me a book for learning Visual Basic.
            I remember it was my first encounter to programming.
          </p>
          <br />
          <p>
            My older brother, who has many experience on competitive programming, handed me a book for learning Visual Basic. I remember it was my first encounter to programming.
          </p>
          <p>
            My older brother, who has many experience on competitive programming, handed me a book for learning Visual Basic. I remember it was my first encounter to programming.
          </p>
